About molecular-rectifier-feedstock
===================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/molecular-rectifier-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/molecular-rectifier-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add molecular-rectifier
# for installing globally
pixi global install molecular-rectifier
```
...
It is possible to list all of the versions of `molecular-rectifier` available on your platform:
...
```
pixi search molecular-rectifier --channel conda-forge
```
